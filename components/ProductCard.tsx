...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <motion.div 
      ...
      className="group relative bg-[#1a1a1a] rounded-xl overflow-hidden flex flex-col h-full hover:shadow-xl hover:shadow-black/50 transition-all duration-300 border border-neutral-900"
    >
      {/* Badges */}
        ...
        <div className="mt-auto flex items-end justify-between">
          <div className="flex flex-col">
            ...
            <div className={`text-xl font-bold font-mono text-white`}>
              {product.price.toLocaleString('bg-BG')} <span className="text-sm text-gray-500 font-sans font-normal">лв.</span>
            </div>
          </div>

                  ...
                  {filteredProducts.map(product => (
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <span className="text-neutral-400 font-mono text-sm mt-1">{product.price.toLocaleString('bg-BG')} лв.</span>
                      </div>
                    </Link>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredServices.map(service => (
                    ...
                    >
                      ...
                      <span className="font-mono text-brand-accent font-bold text-sm">{service.price.toFixed(2)} лв</span>
                    </Link>
                  ))}
                </div>
              </div>

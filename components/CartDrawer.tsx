          ...
          >
            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-neutral-800 bg-neutral-900/80 backdrop-blur">
                ...
                <button className="w-full bg-white text-black font-black text-sm uppercase py-4 rounded-xl hover:bg-brand-accent hover:shadow-lg hover:shadow-brand-accent/20 transition-all active:scale-[0.98]">
                  Към Плащане
                </button>
              </div>
            )}
